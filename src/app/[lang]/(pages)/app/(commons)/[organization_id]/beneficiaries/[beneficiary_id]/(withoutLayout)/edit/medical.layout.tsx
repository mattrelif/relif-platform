        ...
        <>
            <div className="w-full h-max flex flex-col gap-6 p-4 border border-slate-200 rounded-lg">
                <h2 className="text-relif-orange-200 font-bold flex items-center gap-2">
                    <MdHealthAndSafety /> {dict.commons.beneficiaries.edit.medical.title}
                </h2>

                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="allergies">
                        {dict.commons.beneficiaries.edit.medical.allergies}
                    </Label>
                    <Input
                        id="allergies"
                        name="allergies"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="currentMedications">
                        {dict.commons.beneficiaries.edit.medical.currentMedications}
                    </Label>
                    <Input
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="chronicMedicalConditions">
                        {dict.commons.beneficiaries.edit.medical.chronicalMedicalConditions}
                    </Label>
                    <Input
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="healthInsurance">
                        {dict.commons.beneficiaries.edit.medical.healthInsurance}
                    </Label>
                    <Input
                        id="healthInsurance"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="vaccinations">
                        {dict.commons.beneficiaries.edit.medical.vaccinations}
                    </Label>
                    <Input
                        id="vaccinations"
                        name="vaccinations"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="mentalHealth">
                        {dict.commons.beneficiaries.edit.medical.mentalHealth}
                    </Label>
                    <Input
                        id="mentalHealth"
                        name="mentalHealth"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="height">{dict.commons.beneficiaries.edit.medical.height}</Label>
                    <Input
                        id="height"
                        name="height"
                        type="number"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="weight">{dict.commons.beneficiaries.edit.medical.weight}</Label>
                    <Input
                        id="weight"
                        name="weight"
                        type="number"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="addictions">
                        {dict.commons.beneficiaries.edit.medical.addictions}
                    </Label>
                    <Input
                        id="addictions"
                        name="addictions"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="disabilities">
                        {dict.commons.beneficiaries.edit.medical.disabilities}
                    </Label>
                    <Input
                        id="disabilities"
                        name="disabilities"
                ...
                <div className="flex flex-col gap-3 w-full">
                    <Label htmlFor="prothesisOrMedicalDevices">
                        {dict.commons.beneficiaries.edit.medical.prothesisOrMedicalDevices}
                    </Label>
                    <Input
